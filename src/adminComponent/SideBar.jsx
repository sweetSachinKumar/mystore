...
import { logOutbtn, removeVender, setVender } from '../slices/AuthSlice'
            ...
            <li className="pt-4">
              ...
              <ul>
                ...
                <li>
                  ...
                  <div onClick={handleLogout} className="flex items-center rounded-lg px-6 py-2 text-[.85rem] transition duration-300 ease-linear hover:bg-gray-900/60">
                    <span className="mr-4 [&>svg]:h-5 [&>svg]:w-5 [&>svg]:text-gray-400 dark:[&>svg]:text-gray-300">
                      <BiLogOut />
                    </span>
                    <span>logout</span>
